...
const getInitialFormValues = (
  ...
  customSplits: expense
    ? Object.fromEntries(
        expense.splits.map((split) => [split.tripMember.id, split.owedAmount]),
      )
    : {},
  note: expense?.note ?? "",
});
...
const AddExpenseModal = ({
  ...
  const customSplitsErrorMessage =
    customSplitsError &&
    "message" in customSplitsError &&
    typeof customSplitsError.message === "string"
          ...
          >
            {members.length === 0 ? (
              <Text className="text-sm text-red-500">
                No trip members are available.
              </Text>
            ) : null}
            <View>
              <Text className="mb-1 text-sm font-semibold text-[#445160]">
                Title
              </Text>
              <Controller
                control={control}
            ...
            <View>
              <Text className="mb-2 text-sm font-semibold text-[#445160]">
                Paid by
              </Text>
                ...
                {members.map((member) => {
                  ...
                  return (
                    <Pressable
                      ...
                      onPress={() =>
                        setValue("paidByMemberId", member.id, {
                          shouldValidate: true,
                        })
                      }
                    >
                ...
                {[
                  ...
                  return (
                    <Pressable
                      ...
                      onPress={() =>
                        setValue("splitType", option.value, {
                          shouldValidate: true,
                        })
                      }
                    >
              ...
              {splitType === "CUSTOM" ? (
                <View className="mt-3 gap-2 rounded-xl bg-[#f7fafc] p-3">
                  ...
                  <View className="mt-1 flex-row justify-between border-t border-[#dce5ed] pt-2">
                    <Text className="text-xs font-semibold text-[#647184]">
                      Custom total
                    </Text>
                    <Text className="text-xs font-bold text-[#263342]">
            ...
            <View>
              ...
              <Controller
                ...
                render={({ field: { onBlur, onChange, value } }) => (
                  <TextInput
                    className="min-h-18 rounded-xl border border-[#d5dde7] px-3 py-2 text-base text-[#263342]"
                    multiline
